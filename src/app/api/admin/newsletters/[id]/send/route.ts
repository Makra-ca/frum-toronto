...
/**
 * Build per-subscriber HTML from the stored previewHtml template.
 * previewHtml is rendered with PREVIEW_TOKEN as placeholder — replace it with
 * the real unsubscribe token and inject the open-tracking pixel.
 */
