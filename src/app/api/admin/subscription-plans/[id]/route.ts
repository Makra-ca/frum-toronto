...
const updatePlanSchema = z.object({
  ...
  maxCategories: z.number().int().min(1).max(100),
  ...
  showInHomepageBanner: z.boolean(),
  showVideo: z.boolean(),
  showShoutouts: z.boolean(),
  showInHomepageSidebar: z.boolean(),
  ...
  try {
    ...
    const [updated] = await db
      ...
      .set({
        ...
        showShoutouts: data.showShoutouts,
