...
/**
 * A submitter's own shiva notice: read it back for the edit form, and save changes.
 *
...
export async function GET(
  ...
  return handleSubmissionGet("shiva", params);
}
...
export async function PATCH(
  ...
  return handleSubmissionEdit("shiva", request, params);
}
