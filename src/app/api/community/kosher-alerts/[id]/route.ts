...
/**
 * A submitter's own kosher alert: read it back for the edit form, and save changes.
 *
...
export async function GET(
  ...
  return handleSubmissionGet("kosherAlert", params);
}
...
export async function PATCH(
  ...
  return handleSubmissionEdit("kosherAlert", request, params);
}
