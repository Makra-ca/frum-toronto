...
/**
 * A submitter's own community alert: read it back for the edit form, and save changes.
 *
...
export async function GET(
  ...
  return handleSubmissionGet("alert", params);
}
...
export async function PATCH(
  ...
  return handleSubmissionEdit("alert", request, params);
}
