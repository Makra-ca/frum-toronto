...
/**
 * A submitter's own tehillim entry: read it back for the edit form, and save changes.
 *
...
export async function GET(
  ...
  return handleSubmissionGet("tehillim", params);
}
...
export async function PATCH(
  ...
  return handleSubmissionEdit("tehillim", request, params);
}
