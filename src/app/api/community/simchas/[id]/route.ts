...
/**
 * A submitter's own simcha announcement: read it back for the edit form, and save changes.
 *
...
export async function GET(
  ...
  return handleSubmissionGet("simcha", params);
}
...
export async function PATCH(
  ...
  return handleSubmissionEdit("simcha", request, params);
}
