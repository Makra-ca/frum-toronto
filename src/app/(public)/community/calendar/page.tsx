  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* The clip lives on the decorative layer below, NOT on this wrapper.
          The blobs are sized to bleed past the hero and must stay contained,
          but clipping here also ate the search dropdown, which is positioned
          `absolute top-full` and legitimately extends past the hero's edge. */}
