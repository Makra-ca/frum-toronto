...
import { Heart, Flower2, BookHeart, Bell, ShieldAlert, MapPin, Phone, Newspaper } from "lucide-react";
...
const communityTabs = [
  ...
  { href: "/admin/community/newsletters", label: "Newsletters", icon: Newspaper },
